  ...
  return (
    <div className="grid md:grid-cols-12 2xl:grid-cols-7 gap-4">
      <ListaCardProvider lista={listaCartas}>
        ...
        <div className="md:col-start-2 md:col-span-10 2xl:col-span-5 2xl:col-start-2 row-start-2 flex justify-end items-center mt-7">
          <div className="grid w-full grid-cols-11 grid-rows-1">
            ...
            {CardIniciado2 && (
              <div className="col-span-5 row-start-1 col-start-7 flex 2xl:justify-start md:justify-center items-center px-2">
        ...
        {CardIniciado1 && CardIniciado2 && (
          <div className="md:col-start-2 md:col-span-10 2xl:col-span-5 2xl:col-start-2 row-start-4 bg-painel flex justify-center items-center rounded-xl px-1 py-1">
